...
/**
 * {@link ValidatorHandler} that forwards every method to a wrapped delegate.
 */
class DelegatingValidatorHandler extends ValidatorHandler {

    private final ValidatorHandler delegate;

    DelegatingValidatorHandler(final ValidatorHandler delegate) {
